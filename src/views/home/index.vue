  ...
  <div class="home">
    <Layout>
      ...
      <Content style="display: flex; height: calc(100vh - 64px)">
        <!-- 左侧区域 -->
        <div v-if="state.show" :class="`left-bar ${false && 'show-tools-bar'}`">
          ...
          <!-- 关闭按钮 -->
          <div class="close-btn" v-show="false" @click="hideToolsBar"></div>
        </div>
        ...
        <div class="right-bar" v-show="state.attrBarShow">
          <Menu :active-name="state.menuActive" mode="horizontal" accordion @on-select="showToolsBar" width="65px">
            <MenuItem :name="5" class="menu-item">
            <Icon type="md-git-commit" size="24" />
            AI相关
            </MenuItem>
